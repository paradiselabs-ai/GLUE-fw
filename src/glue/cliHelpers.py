...
def format_agent_interactions(interactions: List[Dict[str, Any]], color_enabled: bool = False) -> List[str]:
    """
    ...
    """
    return [
        format_agent_message(interaction["agent"], interaction["message"], color_enabled)
