...
class MagneticField:
    ...
    async def _analyze_team_compatibility(self, team: Team) -> None:
        ...
        for existing_team_name, existing_team in self.teams.items():
            ...
            if repulsion_key in self.repulsions or reverse_key in self.repulsions:
                logger.warning(f"Teams {team.name} and {existing_team_name} are repelled")
    ...
    async def set_flow(
        ...
        if not source or not target:
            ...
            if source_team not in self.teams.keys() or target_team not in self.teams.keys():
    ...
    async def _bidirectional_transfer(self, source_team: str, target_team: str, content: Any) -> None:
    ...
    async def _push_transfer(self, source_team: str, target_team: str, content: Any) -> None:
    ...
    async def _pull_transfer(self, source_team: str, target_team: str, content: Any) -> None:
    ...
    def start_monitoring(self) -> None:
        ...
        try:
            ...
            logger.warning(f"No running event loop for field {self.name}, monitoring not started")
