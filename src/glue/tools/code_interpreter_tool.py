...
class CodeInterpreterTool(Tool):
    ...
    def __init__(
        ...
        if config is None:
            config = ToolConfig(required_permissions={ToolPermission.EXECUTE})
    ...
    async def _execute(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(input_data, str):
            ...
            logger.debug(
                "CodeInterpreterTool received raw string input, assuming Python code."
            )
        # Check if input_data is a dictionary
            ...
            return {
                "success": False,
                "error": "Invalid input_data format. Expected string or dict.",
            }
        ...
        try:
            ...
            with redirect_stdout(stdout_capture), redirect_stderr(stderr_capture):
                ...
                try:
                    ...
                    if last_line and not last_line.strip().startswith(
                        (
                            "#",
                            "import",
                            "from",
