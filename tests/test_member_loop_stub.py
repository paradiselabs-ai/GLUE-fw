...
from glue.core.schemas import ParseAnalyzeOutput, PlanPhaseOutput, ToolSelectionOutput
...
def member_loop():
    ...
    return TeamMemberAgentLoop(agent_id='agent', team_id='team', report_tool=DummyReportTool(), agent_llm=None)
